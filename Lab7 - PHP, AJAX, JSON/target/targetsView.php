...
class TargetsView{
    ...
    public function printAllTargets($result){
        if ($result->num_rows > 0){
            ...
            echo "<table style = 'border-collapse: collapse;'>  <col width='50'><col width='100'><col width='100'><col width='100'><col width='100'><tr> " . 
            ...
            while ($row = $result->fetch_assoc()){
                ...
                echo "<th style = 'border:1px solid black'>" . $row["Price"] . "</th>";
    ...
    public function printTarget($dest){
        ...
        if ($dest == NULL){
            ...
            echo "ID: " . $dest->getTargetID() . "<br>Name: " . $dest->getName() . "<br>Description: " . $dest->getDescription() . "<br>Price: " . $dest->getPrice() . "<br>DestinationID: " . $dest->getDestinationID();
    }
}
